...
//        registry.setApplicationDestinationPrefixes("/pub"); // "/pub" 시작되는 메시지가 message-handling 메소드로 라우팅 되도록 명시
        registry.enableSimpleBroker("/sub");		      // "/sub" 시작되는 메시지가 메시지 브로커로 라우팅 되도록 명시
    }
}
